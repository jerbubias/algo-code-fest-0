...
/* Ant Colony Optimisation - Ant System */

/* Inspired on the pseudocode (Algorithm 110) in Essentials of Metaheuristics by Sean Luke
...
int main(int argc, char **argv)
{
    ...
    double ph_val, ph_wt, cost_wt, evp_rate, Q, cost, auxcost, mincost = DBL_MAX, *ph, *enumDes, *phRate, sum;
