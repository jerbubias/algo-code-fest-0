 ...
 * The function returns a pointer to the problem
 * Status: INTERIM
 * Notes:
 *   Add return case
 */
 ...
 * with opposite subneighbourhood. For example, after an ADD move generated for
 * a given solution is applied to that solution, it may be applied again as a
 * REMOVE move to the resulting solution in order to recover the original
...
/* getObjectiveLBIncrement() supports single and multiple objective
 * Status: FIX ME
 */
